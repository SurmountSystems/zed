...
Threads you're no longer working on can be moved to history by hovering over them in the sidebar and clicking the archive icon, or selecting them and pressing {#kb agent::ArchiveSelectedThread}. Thread History holds all your threads and you can restore them at any time.
